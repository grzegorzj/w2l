...
/**
 * Configuration for creating a NewFunctionGraph.
 */
export interface NewFunctionGraphConfig {
  /**
...
/**
 * NewFunctionGraph - Mathematical function plotting component.
 *
...
export class NewFunctionGraph extends NewRectangle {
  private config: NewFunctionGraphConfig;
  ...
  // Position getters inherited from NewRectangle (topLeft, center, etc.)
