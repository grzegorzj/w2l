...
import { Element, type PositionConfig } from "./Element.js";
 ...
 */
export abstract class Shape extends Element implements Stylable {
  ...
  constructor(style?: Partial<Style>) {
    super(); // Call Element constructor for creation index
    if (style) {
      this._style = { ...style };
    }
  }
