...
export const toolSchemas = [
  {
    ...
    function: {
      name: 'get_guides',
      description: 'Retrieve detailed guides for specific topics. Use this to understand how to approach different types of SVG generation tasks.',
      parameters: {
        type: 'object',
        properties: {
          guides: {
            type: 'array',
            items: { type: 'string' },
            description: 'Array of guide IDs to retrieve (e.g., ["basic-shapes", "layouts"])'
          }
        },
        required: ['guides']
      }
  ...
  },
  {
    ...
    function: {
      name: 'get_elements',
      description: 'Retrieve detailed API documentation for specific elements. Use this after reading guides to get exact configuration details for elements you plan to use.',
      parameters: {
        type: 'object',
        properties: {
          elements: {
            type: 'array',
            items: { type: 'string' },
            description: 'Array of element names to retrieve documentation for (e.g., ["Circle", "Rect", "Text"])'
          }
        },
        required: ['elements']
      }
